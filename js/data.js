...
const characters = {
  ...
  "traveler": {
    ...
    element: "多元素",
    emoji: "⭐",
    description: "来自异世界的旅行者，为了寻找失散的血亲而踏上提瓦特的旅程。你 adaptable、善良，在旅途中结识了无数伙伴。",
    traits: ["善良", "adaptable", "好奇", "坚韧", "正义", "孤独"],
